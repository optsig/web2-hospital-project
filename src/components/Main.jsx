function Main() {
    ...
    return (
        <div className="grid grid-cols-12 h-full">
            <div className="h-full col-span-12 md:col-span-7 flex flex-col justify-center ms-24">
            ...
            <div className="h-full col-span-12 md:col-span-5 flex items-center justify-center px-6 pt-9 me-24">
                <img
